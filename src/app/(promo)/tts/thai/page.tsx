      ...
      <div className="flex-1 flex flex-col bg-black/30">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-4">
            ...
            <span className="text-white text-sm">ฟรี 100% • ไม่ต้องสมัคร</span>
          </div>
          ...
          <button
            ...
            className="relative inline-flex items-center gap-2 px-10 py-4 text-white font-bold rounded-full text-xl transition-all mb-4 cursor-pointer"
            style={{
          ...
          <div className="relative w-full max-w-sm mx-auto mb-6">
            {/* Left decoration */}
            <div className="absolute left-0 top-1/4 -translate-x-2 sm:-translate-x-8">
              <span className="text-yellow-400 text-2xl sm:text-3xl font-bold" style={{ textShadow: '0 0 20px rgba(250, 204, 21, 0.5)' }}>
                ฟรี
              </span>
            </div>

            {/* Right decoration */}
            <div className="absolute right-0 top-1/3 translate-x-2 sm:translate-x-8">
              <span className="text-purple-400 text-lg sm:text-xl font-semibold italic" style={{ textShadow: '0 0 20px rgba(192, 132, 252, 0.5)' }}>
                No Limits!
              </span>
            </div>
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-8 mb-6">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">3,200+</div>
              <div className="text-xs sm:text-sm text-gray-400">เสียง</div>
            </div>
            <div className="w-px h-10 bg-gray-600" />
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">192+</div>
            ...
            <div className="text-center">
              <div className="flex items-center gap-1 text-green-400">
                ...
                <span className="text-xl sm:text-2xl font-bold">ฟรี</span>
                <span className="text-base sm:text-lg font-medium">ไม่จำกัด</span>
              </div>
        ...
        <div className="px-4 pb-6 pt-2">
          <div className="flex items-center justify-center gap-3">
            ...
            <Link
              ...
              className="flex items-center gap-2 px-4 py-2 bg-black/80 border border-gray-700 rounded-lg hover:bg-black transition-colors"
            >
            ...
            {/* App Store */}
            <div className="flex items-center gap-2 px-4 py-2 bg-black/80 border border-gray-700 rounded-lg opacity-60 cursor-not-allowed">
              ...
              <div className="text-left">
                ...
                <div className="text-[8px] text-gray-500 leading-none">Coming Soon</div>
              </div>
            </div>
          </div>
        </div>
