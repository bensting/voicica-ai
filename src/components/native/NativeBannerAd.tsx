  ...
  return (
    <>
      <style>{`
        ...
        .banner-card-voice .banner-card-spin {
      ...
      <div className="mx-4">
        <div className="relative rounded-2xl overflow-hidden bg-[#0b0b20] border border-purple-800/30 p-5">
          ...
          <div className="grid grid-cols-2 gap-2.5 mt-4">
            {/* AI Voice */}
            <Link href="/native/create/voice" className="banner-card-wrap banner-card-voice">
              <div className="banner-card-spin" />
              <div className="banner-card-inner bg-purple-900/40">
