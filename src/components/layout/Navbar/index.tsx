...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay - Outside nav to avoid z-index stacking context issues */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-x-0 top-16 bottom-0 z-[60] bg-white backdrop-blur-3xl animate-fade-in p-4 flex flex-col overflow-y-auto">
