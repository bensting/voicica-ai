"""
Video Parser — Vercel Python Serverless Function
...
def _extractor_to_platform(extractor_key: str) -> str:
    """Map yt-dlp extractor_key to our platform name."""
    key = extractor_key.lower()
    for pattern, platform in EXTRACTOR_MAP.items():
        if pattern in key:
            return platform
...
class handler(BaseHTTPRequestHandler):
    ...
    def _parse_video(self, url: str) -> dict:
        ...
        platform = _extractor_to_platform(extractor_key)
