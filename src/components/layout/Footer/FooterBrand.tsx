 ...
 *
 * Displays brand logo, tagline, social links, and language switcher
 */
export default function FooterBrand() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Follow Us - Discord */}
      <div>
        <p className="text-sm text-gray-400 mb-2">{t('footer.followUs')}</p>
        <Link
          href="https://discord.gg/7HppVVqhxY"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center w-9 h-9 bg-[#5865F2] rounded-lg hover:opacity-80 transition-opacity"
        >
          <svg
