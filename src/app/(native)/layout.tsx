...
// 不显示顶部导航的路径
const hideNavbarPaths = ['/native/me', '/native/settings', '/native/create', '/native/video', '/native/voice/task'];

// 不显示底部导航的路径
const hideBottomNavPaths = ['/native/settings', '/native/create', '/native/video', '/native/voice/task'];
