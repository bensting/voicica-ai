...
export default function VideoDownloaderPageContent({
  locale,
}: VideoDownloaderPageContentProps) {
  const content = VIDEO_DOWNLOADER_CONTENT[locale] || VIDEO_DOWNLOADER_CONTENT.en;
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      {/* Video Downloader Showcase */}
      <VideoDownloaderShowcase locale={locale} />
