    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600">{t('studio.aiSong.createPreview.creating')}</p>
          <p className="text-sm text-gray-400">{t('studio.aiSong.createPreview.creatingTime')}</p>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-4">
        ...
        {hasVersion2 && (
          <div className="flex items-center justify-center gap-2">
            <span className="text-sm text-gray-500">{t('studio.aiSong.createPreview.selectVersion')}</span>
            <div className="flex bg-gray-100 rounded-lg p-1">
              ...
              >
                {t('studio.aiSong.createPreview.version')} 1
              </button>
              <button
                type="button"
              ...
              >
                {t('studio.aiSong.createPreview.version')} 2
              </button>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-2">
              <h4 className="font-semibold text-gray-900 truncate">
                {generatedTitle || t('studio.aiSong.fallbackTitle', { theme: theme?.label || '' })}
                {hasVersion2 && <span className="text-xs text-gray-400 ml-2">({t('studio.aiSong.createPreview.version')} {selectedVersion})</span>}
              </h4>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  title={t('studio.aiSong.createPreview.download')}
                >
        ...
        {displayLyrics && (
          <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-2">
            <h4 className="font-medium text-gray-900 text-sm">{t('studio.aiSong.createPreview.lyrics')}</h4>
        ...
        >
          ...
          {t('studio.aiSong.createPreview.regenerateSong')}
        </button>
        ...
        >
          🎬 {t('studio.aiSong.createPreview.continueToMV')}
        </button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-xl p-5 space-y-4">
        <h3 className="font-semibold text-gray-900 text-sm">{t('studio.aiSong.createPreview.yourConfig')}</h3>
      ...
      <div className="bg-gradient-to-br from-pink-50 to-fuchsia-50 rounded-xl p-5 space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-gray-900 text-sm">{t('studio.aiSong.createPreview.lyricsPreview')}</h3>
          <span className="text-xs text-gray-500">{lyrics.length} {t('studio.aiSong.lyricsEditor.characters')}</span>
        </div>

        <div className="bg-white rounded-lg p-4 max-h-48 overflow-y-auto">
          <pre className="text-sm text-gray-700 whitespace-pre-wrap font-sans leading-relaxed">
            {lyrics || t('studio.aiSong.createPreview.noLyrics')}
          </pre>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <label className="block text-sm font-medium text-gray-700">{t('studio.aiSong.createPreview.songTitle')}</label>
          <span className="text-xs text-gray-400">{t('studio.aiSong.createPreview.optional')}</span>
        </div>
        <input
          type="text"
          value={title}
          onChange={(e) => onTitleChange(e.target.value)}
          placeholder={t('studio.aiSong.fallbackTitle', { theme: theme?.label || '' })}
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <label className="block text-sm font-medium text-gray-700">{t('studio.aiSong.createPreview.musicStyle')}</label>
          <span className="text-xs text-gray-400">{t('studio.aiSong.createPreview.optional')}</span>
        </div>
        <div className="relative">
          <textarea
            ...
            placeholder={t('studio.aiSong.createPreview.stylePlaceholder')}
          ...
          {onGenerateStyle && (
            ...
            >
              ...
              {isGeneratingStyle ? t('studio.aiSong.createPreview.generating') : t('studio.aiSong.createPreview.aiGenerate')}
            </button>
          )}
        </div>
        <p className="text-xs text-gray-400">
          {t('studio.aiSong.createPreview.styleTip')}
        </p>
      </div>

      {/* 声音性别 */}
      <div className="space-y-2">
        <label className="block text-sm font-medium text-gray-700">{t('studio.aiSong.createPreview.voice')}</label>
        <div className="grid grid-cols-3 gap-3">
          ...
          >
            ...
            <div className="text-sm font-medium">{t('studio.aiSong.createPreview.auto')}</div>
          </button>
          <button
            type="button"
          ...
          >
            <div className="text-xl mb-1">👨</div>
            <div className="text-sm font-medium">{t('studio.aiSong.createPreview.male')}</div>
          </button>
          <button
            type="button"
          ...
          >
            <div className="text-xl mb-1">👩</div>
            <div className="text-sm font-medium">{t('studio.aiSong.createPreview.female')}</div>
          </button>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
        <div className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>{t('studio.aiSong.createPreview.myCredits')}: <span className="font-semibold text-gray-900">{userCredits}</span></span>
        </div>
        <div className="flex items-center gap-2 text-sm text-gray-600">
          <span>{t('studio.aiSong.createPreview.cost')}: <span className="font-semibold text-pink-600">{creditsRequired}</span> {t('studio.aiSong.createPreview.credits')}</span>
        </div>
      </div>
      ...
      {!hasEnoughCredits && (
        <div className="p-3 bg-red-50 border border-red-200 rounded-xl">
          <p className="text-sm text-red-600 text-center">
            {t('studio.aiSong.createPreview.insufficientCredits')}
          </p>
        </div>
      )}
      ...
      >
        ...
        {t('studio.aiSong.createPreview.startGenerate')}
