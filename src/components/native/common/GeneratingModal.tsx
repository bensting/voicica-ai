...
const typeConfig: Record<GeneratingType, {
  ...
  'image-tool': {
    generatingTitle: 'Processing image...',
    generatingIcon: <div className="text-gray-400 animate-pulse text-2xl">✨</div>,
    successTitle: 'Image Processed!',
    successMessage: 'Your image has been processed successfully.',
    estimatedTime: '10-30 seconds',
  },
  download: {
    ...
    generatingIcon: (
      <div className="relative w-8 h-8">
        ...
        {/* Icon with bounce */}
        <svg className="w-8 h-8 text-gray-400 animate-bounce" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
