  ...
  stripe: {
    text_to_speech: [
      ...
      // Basic 计划 (月付)
      {
        ...
        product_type: 'text_to_speech',
        plan_name: 'Basic',
        product_id: 'prod_test_basic_monthly', // TODO: 替换为实际的 Stripe 测试 Product ID
        display_name: {
          en: 'Basic Plan',
          'zh-CN': '基础版',
          'zh-TW': '基礎版',
        ...
        discounted_price: { USD: 0.01, CNY: 0.01, TWD: 1, THB: 1 }, // 开发测试价格
      ...
      // Premium 计划 (月付) - 推荐
      {
        ...
        product_type: 'text_to_speech',
        plan_name: 'Premium',
        product_id: 'prod_test_premium_monthly', // TODO: 替换为实际的 Stripe 测试 Product ID
        display_name: {
          en: 'Premium Plan',
          'zh-CN': '高级版',
          'zh-TW': '進階版',
        ...
        discounted_price: { USD: 0.02, CNY: 0.02, TWD: 2, THB: 2 }, // 开发测试价格
        billing_period: 'month',
        active: true,
        sort_order: 3,
      },
      ...
      // Plus 计划 (月付)
      {
        ...
        product_type: 'text_to_speech',
        plan_name: 'Plus',
        product_id: 'prod_test_plus_monthly', // TODO: 替换为实际的 Stripe 测试 Product ID
        display_name: {
          en: 'Plus Plan',
          'zh-CN': '专业版',
          'zh-TW': '專業版',
        ...
        discounted_price: { USD: 0.05, CNY: 0.05, TWD: 5, THB: 5 }, // 开发测试价格
        billing_period: 'month',
        active: true,
        sort_order: 4,
      },
